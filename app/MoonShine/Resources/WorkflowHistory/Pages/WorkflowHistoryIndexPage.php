...
namespace App\MoonShine\Resources\WorkflowHistory\Pages;
...
/**
 * @extends IndexPage<WorkflowHistoryResource>
 */
class WorkflowHistoryIndexPage extends IndexPage
{
...
Date::make('Performed At', 'performed_at'),
