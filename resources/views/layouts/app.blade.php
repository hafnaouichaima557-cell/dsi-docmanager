...
<head>
    ...
    <link
        ...
        rel="stylesheet"
    >
    <link rel="icon" type="image/x-icon" href="{{ asset('images/logo-icosnet.ico') }}">
    ...
    <style>
        ...
        * {
        ...
        .sidebar-logo-icon {
            ...
            box-shadow:
                0 4px 10px rgba(79, 142, 247, 0.4);
    ...
    <div class="sidebar d-flex flex-column">
        ...
        <div class="sidebar-logo d-flex align-items-center gap-2">
            ...
            <div class="sidebar-logo-icon">
                ...
                <img
                    src="{{ asset('images/logo-icosnet.png') }}"
                    alt="icosnet"
                >
        ...
        <nav class="sidebar-nav flex-grow-1 py-1">
            ...
            @if(auth()->user()->hasRole('responsable') || auth()->user()->isAdmin())
                ...
                <a
                    href="{{ route('workflow.validation') }}"
        ...
        <div class="sidebar-user">
            ...
            >
                ...
                <button
                    type="submit"
                    class="btn btn-link p-0 sidebar-logout-btn"
                >
        ...
        <div class="topbar d-flex align-items-center justify-content-between gap-3">
            ...
            <div class="d-flex align-items-center gap-2 flex-shrink-0">
                ...
                >
                    ...
                    <img
                        src="{{ asset('images/logo-icosnet.png') }}"
                        alt="icosnet" height="32" style="border-radius:8px"
                    >
            ...
            >
                ...
                <div class="input-group input-group-sm px-2">
                    ...
                    <span class="input-group-text kbd-hint border-0 bg-transparent">
                        ⌘K
                    </span>
            ...
            <div class="d-flex align-items-center gap-3">
                ...
                <div class="position-relative">
                    ...
                    <button
                        class="icon-btn position-relative border-0"
                    ...
                    >
                        ...
                        @forelse(auth()->user()->notifications->take(5) as $notif)
                            ...
                            <div
                                class="dropdown-item py-2 {{ $notif->read_at ? '' : 'bg-light' }}"
                            ...
                            >
                                ...
                                <div class="d-flex align-items-start gap-2">
                                    ...
                                    <i
                                        class="bi bi-bell-fill text-primary mt-1"
                                        style="font-size:12px"
                                    ></i>
